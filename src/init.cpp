...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/EdinarCoin/EdinarCoin>";
    const std::string URL_WEBSITE = "<https://www.edinarcoin.org/>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("EdinarCoin version %s\n", FormatFullVersion());
}
